...
import TimeGrid, { Body } from "@event-calendar/time-grid";
...
let test = document.getElementById("ec");
...
function createEvents() {
	...
	return [
...

		{
			...
			resourceId: 11,
			title: "wesh je commence a capter le machine truc bizzare",
			color: "#133984",
			allDay: true,
		},
	];
